...
export default function ContactForm() {
  ...
  return <form className={styles.form} onSubmit={submit} noValidate>
    ...
    {status === "success" && <div className={styles.feedback} aria-live="polite"><p className={styles.success}><strong>MESSAGE SENT.</strong><span>Thanks for reaching out.<br/>I'll get back to you soon.</span></p></div>}
    {status === "error" && <div className={styles.feedback} aria-live="polite"><p className={styles.error}><strong>MESSAGE NOT SENT.</strong><span>Please try again or email me directly at<br/><a href="mailto:su59201@gmail.com">su59201@gmail.com</a></span></p></div>}
  </form>;
}
