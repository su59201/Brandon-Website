...
const cases=[
 ...
 {number:"03",href:"/work/weihai-port",status:"VIEW CASE →",category:"CROSS-BORDER SUPPLY CHAIN · OPERATIONS · MARKET DEVELOPMENT",title:"BUILDING A CROSS-BORDER SUPPLY CHAIN FROM ZERO.",company:"WEIHAI PORT AUTHORITY · KOREA REPRESENTATIVE OFFICE · 2009–2012",context:"Built a Korea representative office and led a profitable agricultural supply-chain project from Inner Mongolia to South Korea.",proof:"~100+ REEFER CONTAINERS · 6–8 MONTHS · CHINA → KOREA"},
];
